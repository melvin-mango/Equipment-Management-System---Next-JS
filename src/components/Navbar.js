    ...
    return (
        <nav className="flex w-full justify-between items-center border-b-4 border-indigo-300 px-10 py-4 bg-indigo-200">
            ...
            <div className="hidden lg:flex gap-12 text-blue-950">
                <Link href="/student/equipment" className={linkClass("/student/equipment")}>
                    Equipment
                </Link>
                <Link href="/student/borrow_request" className={linkClass("/student/borrow_request")}>
                    Borrow Request
                </Link>
                <Link href="/student/security" className={linkClass("/student/security")}>
                    Security Check
                </Link>
            </div>
